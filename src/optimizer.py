...
class NutritionOptimizer:
    ...
    # Objective: Minimize total weight with random variation for variety
        random_coeffs = {fid: random.uniform(0.95, 1.05) for fid in food_vars}
        prob += pulp.lpSum([food_vars[fid] * random_coeffs[fid] for fid in food_vars])
